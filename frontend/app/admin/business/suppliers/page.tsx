...
export default function SuppliersPage() {
  ...
  const canRead = !loading && hasPermission(permissions, 'supplier.read')
  const canWrite = !loading && hasPermission(permissions, 'supplier.write')
  const canUpdate = !loading && hasPermission(permissions, 'supplier.update')
  const canDelete = !loading && hasPermission(permissions, 'supplier.delete')

  return (
    <PermissionGuard permission="supplier.view">
      <div className="p-6">
        <div className="mb-6">
        ...
        <div className="rounded-lg border-2 border-dashed bg-card p-12 text-center">
          ...
          <p className="text-muted-foreground mb-4">
            The Suppliers module is currently under development.
          </p>
