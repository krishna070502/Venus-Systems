...
export default function StockPage() {
  ...
  const canRead = !loading && hasPermission(permissions, 'stock.read')
  const canWrite = !loading && hasPermission(permissions, 'stock.write')
  const canUpdate = !loading && hasPermission(permissions, 'stock.update')
  const canDelete = !loading && hasPermission(permissions, 'stock.delete')
