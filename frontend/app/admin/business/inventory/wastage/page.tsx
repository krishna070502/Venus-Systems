...
export default function WastagePage() {
  ...
  const canRead = !loading && hasPermission(permissions, 'wastage.read')
  const canWrite = !loading && hasPermission(permissions, 'wastage.write')
  const canUpdate = !loading && hasPermission(permissions, 'wastage.update')
  const canDelete = !loading && hasPermission(permissions, 'wastage.delete')
      ...
      <div className="p-6">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-muted-foreground mt-2">
                Track and manage inventory wastage and losses
              </p>
            </div>
            {canWrite && (
              <button
        ...
        <div className="rounded-lg border-2 border-dashed bg-card p-12 text-center">
          ...
          <p className="text-muted-foreground mb-4">
            The Wastage Tracking module is currently under development.
          </p>
