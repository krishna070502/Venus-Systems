...
export default function ExpensesPage() {
  ...
  const canRead = !loading && hasPermission(permissions, 'expense.read')
  const canWrite = !loading && hasPermission(permissions, 'expense.write')
  const canUpdate = !loading && hasPermission(permissions, 'expense.update')
  const canDelete = !loading && hasPermission(permissions, 'expense.delete')
      ...
      <div className="p-6">
        ...
        <div className="rounded-lg border-2 border-dashed bg-card p-12 text-center">
          ...
          <p className="text-muted-foreground mb-4">
            The Expenses Management module is currently under development.
          </p>
