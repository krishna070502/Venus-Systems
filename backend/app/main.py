...
from app.routers import auth, users, roles, permissions, admin, health, business_management, rate_limits, ai, activity_logs, user_dashboard, transaction_logs
...
app.include_router(transaction_logs.router, prefix="/api/v1/transaction-logs", tags=["Transaction Logs"])
app.include_router(user_dashboard.router, prefix="/api/v1/user/dashboard", tags=["User Dashboard"])
